...
const Introduction = () => {
  ...
  return (
    <div className="intro-comp">
      <div className="intro-detail-cont">
        <h1>
          Unlock a world of digital treasures, where your dreams become tokens
          of reality.
        </h1>
        <h3>
          ...
          and rare digital assets, each a masterpiece waiting to be discovered
          and owned. Join the NFT revolution today and start collecting,
          creating, and connecting with the future of digital ownership.
        </h3>
